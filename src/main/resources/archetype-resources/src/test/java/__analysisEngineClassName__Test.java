...
import ${package}.${analysisEngineClassName};
...
public class ${analysisEngineClassName}Test {
	...
	public void setup() throws ResourceInitializationException {
		component = createEngineDescription(${analysisEngineClassName}.class);
	}
	...
	private JCas runComponent(String text, boolean caseSensitive) throws UIMAException {
		component.getAnalysisEngineMetaData().getConfigurationParameterSettings()
				.setParameterValue(${analysisEngineClassName}.PARAM_CASE_SENSITIVE, caseSensitive);
